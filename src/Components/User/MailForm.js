...
export default function MailForm() {
  ...
  const handleSubmit = async () => {
    ...
    if (valid) {
      try {
        await axios.post(
          "https://pentaclemarketings.azurewebsites.net/api/form/create",
          formData
        );
        Swal.fire({
          icon: "success",
  ...
  return (
    <div>
      <Box
        sx={{ width: "100%", display: { sm: "none", md: "block", xs: "none" } }}
      >
        <Stack
          spacing="2%"
          direction="row"
        ...
        >
          ...
          <TextField
            ...
            helperText={
              errors.description &&
              "Vui lòng điền mô tả về dự án của doanh nghiệp."
            }
          ></TextField>
          <Button
            onClick={handleSubmit}
            variant="contained"
            sx={{ backgroundColor: "#38b083", width: "100%", marginTop: "2%" }}
          >
            Gửi
          </Button>
        </Stack>
